...
})({"aWO0X":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "c4ab06dc79d0bc58";
...
},{}],"cggbj":[function(require,module,exports) {
...
if (ListContainer) ListContainer.addEventListener("change", (e)=>{
    if (e.target.tagName === "INPUT" && e.target.type === "checkbox") completeTodo(e.target);
});
...
const completeTodo = (inputElement)=>{
    ...
    inputElement.parentElement.nextElementSibling.firstElementChild.classList.toggle("complete");
};
const removeTask = (removeElement)=>{
    ...
    if (taskList.length === 0) c.style.display = "block";
};
...
},{"../img/icons.svg":"2uN3W","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"2uN3W":[function(require,module,exports) {
module.exports = require('./helpers/bundle-url').getBundleURL('gSRi4') + "icons.21bad73c.svg" + "?" + Date.now();
...
},{}]},["aWO0X","cggbj"], "cggbj", "parcelRequire5af9")

//# sourceMappingURL=index.79d0bc58.js.map
